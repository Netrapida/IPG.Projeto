...
[assembly: ExportRenderer(typeof(MainPage), typeof(IPG.Projeto.Mobile.Droid.Renderers.MainPageRenderer))]
namespace IPG.Projeto.Mobile.Droid.Renderers
{
    internal class MainPageRenderer : VisualElementRenderer<MainPage>, IOnTabClickListener
    {
        ...
        private BottomBar CreateBottomBar(IEnumerable<Page> pageIntents)
        {
            ...
            bar.ItemContainer.SetBackgroundColor(Android.Graphics.Color.WhiteSmoke);
